...
| NOW | NEXT | LATER |
| --- | --- | --- |
| WP6: Extract the BDI application as a package consumer |  | WP7: Harden releases and consider repository extraction |
|  |  | WP8: Migrate additional consumers such as `ccrs-react` from Maven Local |
