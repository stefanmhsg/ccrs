...
| JaCaMo example | [examples.asl](../src/agt/examples/contingency/examples.asl) | Change | AgentSpeak calls pass legacy type strings and comments teach the classification rule. |
