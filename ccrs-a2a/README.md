...
This Gradle module (`ccrs-a2a`) contains the optional A2A-based consultation
capability used by contingency CCRS. It depends on `ccrs-core`, contributes
...
- [A2aConsultationChannel.java](src/main/java/ccrs/capabilities/a2a/A2aConsultationChannel.java)
- [A2aConfig.java](src/main/java/ccrs/capabilities/a2a/A2aConfig.java)
- [A2aConsultationStrategyProvider.java](src/main/java/ccrs/capabilities/a2a/A2aConsultationStrategyProvider.java)
- [Consultation strategy README.md](../ccrs-core/src/main/java/ccrs/core/contingency/strategies/social/README.md)
