...
from ccrs_langgraph.capabilities import CCRS_CORE_MODULE
from ccrs_langgraph.java_runtime import (
    CcrsJavaRuntime,
    CcrsJavaRuntimeError,
    get_default_java_runtime,
)
from ccrs_langgraph.rdf_adapter import CcrsRdfParseError, RdfTripleValue, parse_turtle_triples
...
class VocabularyMatcher:
    ...
    def from_github_packages(
        ...
        *,
        ...
        """Create a matcher whose Java runtime comes from GitHub Packages."""

        return cls(
            java_runtime=CcrsJavaRuntime.from_github_packages(
                group=group,
                version=version,
                modules=modules,
                github_packages_cache=github_packages_cache,
                extra_classpath=extra_classpath,
...
def get_default_vocabulary_matcher() -> VocabularyMatcher:
    ...
    if _default_vocabulary_matcher is None:
        _default_vocabulary_matcher = VocabularyMatcher()
